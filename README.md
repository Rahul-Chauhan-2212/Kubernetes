...
<ul>
<li><h5>Pod-internal Communication</h5>
<p>For Pod internal Communication(Same Pod Container), we can user <b>localhost</b> as the address for the second container.</p>
</li>
<li><h5>Pod to Pod Communication</h5>
<ol>
<li><h5>Using Pod Address and Environment Variables</h5>
<p>Pod to Pod Communication can be achieved using the IP address of Pod(Cluster IP of the Service) and environment variables generated by Kubernetes</p>
</li>
<li><h5>Using DNS</h5>
